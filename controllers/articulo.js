...
const articuloPost=async (req,res)=>{
    ...
    const {codigo,nombre,categoria,stock,precioVenta,descripcion}=req.body
    const articulo =new Articulo({codigo,nombre,categoria,stock,precioVenta,descripcion})
    await articulo.save()
...
const articuloGetbuscar = async (req, res) => {     
...
export {articuloGet,articuloPost,articuloGetbuscar,articuloGetByid,articuloPut,articuloPutActivar,articuloPutDesactivar,articuloDelete}
